...
import { Company, CompanyStats } from "@/shared/types";

interface SingleUserCompanyProps {
  id: string;
}

const SingleUserCompany: React.FC<SingleUserCompanyProps> = ({ id }) => {
  ...
  return (
    <div>
      <CompanyProfile company={company} viewStats={companyStats} />
    </div>
  );
};

export default SingleUserCompany;
